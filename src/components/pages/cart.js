...
function Cart() {
  ...
  var prodjsx = cart.map(prod => {
     return <Grid container item lg={3} md={4} sm={6} xs={12} style={{ marginTop: "3px" }}>
                <Card prod={prod} setProdtoRemove={setProdtoRemove} prodtoRemove={prodtoRemove}/>
            </Grid>
  });
    return (
      <div className={classes.root}>
        <Paper style={{marginTop: "0px" }}>
      <Grid container item lg={12} spacing={1} style={{textAlign:"center",marginLeft:"2px"}} >
        {
          profile?
